...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="CSS/steps-appointment.css"></link>
    ...
    <!-- header ends -->
        ...
        <div class="MainBody">   
          <div class="Top-container">
            <div class="HomeTitle">
                <div class="text1">Online Appointment System  <div class="text2">URS Morong Campus</div> </div>
                
                <div class="appoint-button">
                    <div class="appoint-button-view" onclick="window.location.href='Appointment_form.php'">Make an Appointment<img src="Picture/calendar.png"></div>   
                </div>
            </div>
          ...
          <div class="container-appoint">
            ...
            <div class="txt1">The University will have 50  slots for a day to maximize the number of people going in and out of the university
               and to maintain safety and health protocols.</div>
            <div class="row">
                <div class="col-md-4">
                    <div class="box">
                      <div class="inside-box">
                        <div class="our-category alumni">
                            <div class="icon step1">  </div>
                            <div class="text" >Step 1</div>
                            
                        </div>
                        <div class="info">Firstly, check the available schedules of the desired office prior to making an appointment and select the date and time that is convenient for you.
                        </div>
                      </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="inside-box">
                        ...
                        <div class="info">Go to the home page, then click "MAKE AN APPOINTMENT". You will be redirected to the appointment form,
                           in which you must provide information necessary to request an appointment.</div>
                    </div>
                    </div>
                </div>
                <div class="col-md-4">
                    ...
                    <div class="inside-box">
                        ...
                        <div class="info">Upon submission of the accomplished form, your appointment request will be visible in the Dashboard. Make an appointment during office hours to
                          ensure that your request can be attended immediately. Otherwise, if you made a request beyond office hours, the appointment approval will be done on the next working day.
                ...
                <div class="col-md-4">
                    ...
                    <div class="info">There you go, you have successfully scheduled your appointment! At the time of your transaction, just remember to bring an ID and the QR Code provided to you. The university guard will need to verify your appointment before you can enter the campus.
                    </div>
                      </div>
                    ...
                    <div class="col-md-4">
                      ...
                      <div class="info">In case that an unprecedented conflict of your desired office's schedule occurs, your appointment may be postponed. You will be immediately notified if such an event happened and you will be contacted promptly when your appointment has been rescheduled.
                      </div>
                        </div>
