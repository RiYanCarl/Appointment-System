...
if(isset($_SESSION['Access']) && ($_SESSION['Access']) == "admin"){
    ...
    echo"<script type='text/javascript'> alert('Administration Access Only!!') 
...
<body >
  <!-- header starts -->  
  <header class="header">
        <div class="menu-icon-btn" data-menu-icon-btn>
    ...
    <!-- header ends -->
        ...
        <div class="container-view-appointment">
          <div class="txt">Entry NO. <?php echo $row['id'];?> - Appointment Details</div>
          <div class="btn">
            ...
            <?php if($_SESSION['Access'] == "admin"){?>
              <button class="noselect delete"class="icon" type="submit" name="delete" onclick="openDeleteForm();"><span class='text'>Delete</span><span class="icon" >
              <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
              <path  d="M21.5 6a1 1 0 0 1-.883.993L20.5 7h-.845l-1.231 12.52A2.75 2.75 0 0 1 15.687 22H8.313a2.75 2.75 0 0 1-2.737-2.48L4.345 7H3.5a1
               1 0 0 1 0-2h5a3.5 3.5 0 1 1 7 0h5a1 1 0 0 1 1 1Zm-7.25 3.25a.75.75 0 0 0-.743.648L13.5 10v7l.007.102a.75.75 0 0 0 1.486 0L15 17v-7l-.007-.102a.75.75 0 0 0-.743-.648Zm-4.5 0a.75.75
                0 0 0-.743.648L9 10v7l.007.102a.75.75 0 0 0 1.486 0L10.5 17v-7l-.007-.102a.75.75 0 0 0-.743-.648ZM12 3.5A1.5 1.5 0 0 0 10.5 5h3A1.5 1.5 0 0 0 12 3.5Z"/></svg>
            </span>
            <?php }?></button>
            ...
            <button class="noselect edit" class="icon" onclick="window.location.href='Edit_appointment_data.php?ID=<?php echo $row['id'];?>'"><span class='text ed'>Edit</span>
            ...
            preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24"><path  d="m18.988 2.012l3 3L19.701
             ...
             <button class="noselect back" class="icon" onclick="window.location.href='Dashboard_admin.php'"><span class='text qr'>back</span>
            <span class="icon" ><svg aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
              <path  fill-rule="evenodd" d="M10 2a1 1 0 0 0-1.79-.614l-7 9a1 1 0 0 0 0 1.228l7 9A1 1 0 0 0 10 20v-3.99c5.379.112 7.963 
              1.133 9.261 2.243c1.234 1.055 1.46 2.296 1.695 3.596l.061.335a1 1 0 0 0 1.981-.122c.171-2.748-.086-6.73-2.027-10.061C19.087 8.768 15.694 6.282 10 6.022V2Z" clip-rule="evenodd"/></svg></button>
            
          </div>

          <div Class="pop-up" id="openDeleteForm" style="display:none" ><!--  -->
              <div class="Deleteform">
              <div class="txt-QR" style="font-size: 20px; margin-bottom: 20px">Appointment</div>
              <div class="note" style="font-size: 15px;margin-bottom: 20px ">Are you sure you to delete your appointment?</div>
                <div class="btn-delete" onclick="closeDeleteForm();"><span class='text'>Cancel</span></div>  
                <form action="Delete_appointment_data.php"  method="post">          
                  <div class="btn-delete" class="icon" type="submit" name="delete"><span class='text'>Yes</span><span class="icon" >
                  <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                  <path  d="M21.5 6a1 1 0 0 1-.883.993L20.5 7h-.845l-1.231 12.52A2.75 2.75 0 0 1 15.687 22H8.313a2.75 2.75 0 0 1-2.737-2.48L4.345 7H3.5a1
                  1 0 0 1 0-2h5a3.5 3.5 0 1 1 7 0h5a1 1 0 0 1 1 1Zm-7.25 3.25a.75.75 0 0 0-.743.648L13.5 10v7l.007.102a.75.75 0 0 0 1.486 0L15 17v-7l-.007-.102a.75.75 0 0 0-.743-.648Zm-4.5 0a.75.75
                    0 0 0-.743.648L9 10v7l.007.102a.75.75 0 0 0 1.486 0L10.5 17v-7l-.007-.102a.75.75 0 0 0-.743-.648ZM12 3.5A1.5 1.5 0 0 0 10.5 5h3A1.5 1.5 0 0 0 12 3.5Z"/></svg>
          ...
          <div class="form" >
            <form  id="form" method="post" enctype="multipart/form-data" enctype="value">
              <div class="col-half" >
                <table>
                  <thead>
                    <?php do{?>
                      <tr>
                      <th>Entry ID</th><td > <?php echo $row['id'];?></td> 
                    </tr>
                    <tr>
                      <th>Given Name</th><td > <?php echo $row['first_name'];?></td> 
                    </tr>
                    <tr>
                    <th>Surname</th> <td>  <?php echo $row['last_name'];?></td>              
                    </tr> 
                    </tr>                
                      <th>Category</th>  <td> <?php echo $row['category'];?></td> 
                    </tr>
                    </tr>                
                      <th>Address</th>  <td Class="address"> <?php echo $row['address'];?></td> 
                    </tr>
                    <tr> 
                      <th >Email</th><td> <?php echo $row['email'];?></td>
                    </tr>
                    <tr> 
                      <th>Contacts</th>   <td Class="contact"> <?php echo $row['contact_No'];?></td>
                    </tr> 
                  </thead>
                </table>
                <div class="space"></div> 
                <table>
                  <thead>
                    ...
                    <tr>   
                      <th>Date of arrival</th><td> <?php $orgDate =  $row['date'];
                                                          $newDate = new DateTime($orgDate);
                                                            echo $newDate->format('M  d  Y');
                                                            ?></td>  
                    </tr>
                    <tr> 
                      <th>Time of arrival</th><td> <?php echo $row['time'];?></td>
                    </tr>
                    <tr> 
                      <th>Office/Building</th><td> <?php echo $row['office'];?></td>
                    </tr>
                   
                    <tr> 
                    <th>Reason</th><td> <?php echo $row['purpose_of_appoint'];?></td>
                    </tr>
                    <tr> 
                      <th>Status</th><td> <?php echo $row['status'];?></td>
                    </tr>
                    <tr> 
                       <th>Submited</th> <td> <?php 
                       $orgDate =  $row['added_at'];
                       $newDate = new DateTime($orgDate);
                         echo $newDate->format('M  d  Y, h:i:s A' );
                       ?></td>
                    </tr>
                  </thead>
                </table><?php }while($row = $client->fetch_assoc()); ?>  
        ...
        </div><!-- container-view-appointment ends --> 
