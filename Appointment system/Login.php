...
if(isset($_POST['Login'])) {
  ...
  $sql = "SELECT * FROM login_data WHERE user_name = '$user_name' AND password = '$password'"; 

  
  $user_name =  $con->query($sql) or die ($con->error);
  $row = $user_name->fetch_assoc();
  
  $total = $user_name->num_rows;
...
<section>
  ...
  <div class="box">
   ...
   <div class="container-login"> 
    ...
    <div class="head">
      <img src="Picture/hr-manager.png">
    </div>
    <?php  if(!isset($_SESSION['Login'])){?>
      <head>
          <title>Login</title>
      </head>
      <h2 style="color:white;">LOGIN as Administrator</h2>
      <form method="post">
        ...
        <div class="inputBx">
          ...
          <img src="Picture/user.png" class="username-control">
        </div>
      ...
      <form method="post">
        ...
        <div class="inputBx">
          <button  type="submit" name="Login" >Login</button>
           ...
           <!-- <button type="submit" id="logout" onclick="window.location.href='logout.php'" >Logout</button> -->
           <?php }?>   
