...
$dated=  date("Y/d/m");
// $sql = "SELECT * FROM stakeholder  WHERE added_at = $dated ORDER BY added_at DESC";

$sql = "SELECT * FROM stakeholders   WHERE office ='gymnasium' ORDER BY id DESC";
...
<head>
  ...
  <meta charset="UTF-8">
  <title>Gymnasium Appointments</title>
  ...
  <header class="header">
    ...
    <!-- header ends -->
        ...
        <div class="view-appoint">   
          <div class="txt">Gyms Appointments</div>
