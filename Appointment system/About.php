        ...
        <aside class="sidebar" data-sidebar>
          ...
          <div class="middle-sidebar">
            ...
            <ul class="sidebar-list">
              ...
              <li class="sidebar-list-item active" onclick="window.location.href='About.php'">
                <a href="#" class="sidebar-link">
          ...
          <div class="About">
            <div class="about-section">
              <div class="inner-container">
                  <h2>About Us</h2>
                  <p class="text">
                      The University of Rizal System web-based appointment system is applicable to stakeholders, community, each students and Alumni University. The ability to schedule appointment is making easy for authorized only with QR Code features.
                  </p>
                  <h2>VISION</h2>
                  <p class="text">
              ...
              <!-- <div class="footer">
                  <p class="footer">
                      University Appointment System | 2022 
                  </p>   
              </div> -->
            </div>
          </div>
