...
$get_user = $con->query("SELECT * FROM stakeholders WHERE date = '$date' AND time = '$time' AND email = '$email'");
  ...
  {
    $sql = "INSERT INTO `stakeholders`(`first_name`, `last_name`, `category`, `address`, `contact_No`, `email`, `date`, `time`,`office`, `purpose_of_appoint`, `status` ) VALUES
    ( '$fname', '$lname', '$category', '$address','$contact','$email','$date','$time','$office','$POA','$status')";
...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="CSS/appointment-form.css"></link>
  ...
  <header class="header">
    ...
    <div class="student-form">     
      <div class="container-form">
        ...
        <form action="" method="post"  enctype="multipart/form-data" enctype="value" autocomplete="off">
          ...
          <!-- <div class="col-half" > -->
            ...
            <div class="p" style="margin-top:-25px; font-size: 13.5px; color: black" >Please carefully fill out this Appointment Form (to avoid unwanted data) and we will get back to you as soon as possible.</div>
              ...
              <div class="col-half" >
                <input type="email" name="email" id="email" onchange="updateQremail();" placeholder="ex:email@gmail.com"  required/>
                <input type="tel" maxlength="11" name="contact_No"  id="contactno" onchange="updateQrcontactno();" pattern="[0]{1}[0-9]{10}" placeholder="Ex: 09112223333" required/>
              </div>
            ...
            <div class="half"> -->
              ...
              <div class="input-group" ></div>
              <div class="p" >Purppose of Appointment:</div>
              <input type="text" name="purpose_of_appoint"  id="POA" onchange="updateQrPOA();" placeholder="Purpose Of Appointment" required/>
              <div class="input-group" ></div>
              
              <div class="p" style="color: black; margin-top:5px">
              *NOTE:Please wait for the Approval of your Appointment before going to the University
              you will receive an email once you appointment is approved.</div>
