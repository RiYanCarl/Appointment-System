...
if(isset($_SESSION['ID']) && isset($_SESSION['Login-entry']) && isset($_SESSION['email'])
&& isset($_SESSION['contact_No']) ){
  "Welcome ".$_SESSION['Login-entry'];


 } else if (isset($_SESSION['Login-entry']) && ($_SESSION['Login-entry']) ==  $row['last_name'] ) {
    echo "<script type='text/javascript'> alert('Enter your Last name and Email and contact')   
        ...
        <div class="container-form">
          <!-- Display submission status -->
           ...
           <form action="" method="post" id="form" name="form"enctype="multipart/form-data" enctype="value"><!-- onsubmit="return validate" -->
            <div class="txt">Appointment Form - Edit</div>

            <div class="p" >Entry ID: <?php echo $row['id'];  !empty($postData['id'])?$postData['id']:'';?></div>
           ...
           <button type="update" class="button" id="update" name ="update"  value="Submit the Form">Update </button> 
            ...
            <div class="cancel-btn" onclick="window.location.href='logout_entry.php'">Cancel </div>               
            </form> 
            ...
            <div Class="pop-up" id="openDeleteForm"style="display:none" ><!--   -->
              ...
              <div class="note" style="font-size: 15px;margin-bottom: 20px ">Are you sure you to delete your appointment?</div>
                ...
                <div class="delete-close" onclick="closeDeleteForm();">Cancel </div>  

                <form action="Delete_appointment_data.php"  method="post">          
                  <button class="noselect delete"class="icon" type="submit" name="delete"><span class='text'>Yes</span><span class="icon" >
